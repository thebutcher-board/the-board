'use strict';
(function(){
  const BOOT_VERSION='draft-cockpit-20.2.0';
  ...
  async function boot(){
    ...
    addStyle('front-office-clean.css?v=20.2.0','base');
    addStyle('front-office-layout-v2.css?v=20.2.0','layout');
    addStyle('front-office-intelligence-v2.css?v=20.2.0','intelligence-css');
    addStyle('front-office-liquid.css?v=20.2.0','liquid');
    addStyle('command-surface-v14.css?v=20.2.0','sidecards-base');
    addStyle('command-surface-v15.css?v=20.2.0','hero-base');
    addStyle('cockpit-v5-2-shell.css?v=20.2.0','cockpit-v52-shell');
    addStyle('cockpit-v5-2.css?v=20.2.0','cockpit-v52');
    await addScript('front-office-clean.js?v=20.2.0','renderer');
    window.renderWarroom=()=>window.CleanFrontOffice?.render?.();
    window.renderWarroom();
    await addScript('cockpit-v5-2.js?v=20.2.0','cockpit-v52');
