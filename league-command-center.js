'use strict';
(function(){
  const BOOT_VERSION='liquid-front-office-8.0.0';
  ...
  async function boot(){
    ...
    mount();
    addStyle('front-office-clean.css?v=8.0.0','base');
    addStyle('front-office-layout-v2.css?v=8.0.0','layout');
    addStyle('front-office-intelligence-v2.css?v=8.0.0','intelligence');
    addStyle('front-office-liquid.css?v=8.0.0','liquid');
    addStyle('command-surface-v7.css?v=8.0.0','command-surface');
    addStyle('command-surface-v8.css?v=8.0.0','command-surface-polish');
    await addScript('front-office-clean.js?v=8.0.0','renderer');
    window.renderWarroom=()=>window.CleanFrontOffice?.render?.();window.renderWarroom();
    await addScript('front-office-intelligence-v2.js?v=8.0.0','intelligence');
  }
