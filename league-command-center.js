'use strict';
(function(){
  const BOOT_VERSION='draft-cockpit-20.1.0';
  ...
  async function boot(){
    ...
    addStyle('front-office-clean.css?v=20.1.0','base');
    addStyle('front-office-layout-v2.css?v=20.1.0','layout');
    addStyle('front-office-intelligence-v2.css?v=20.1.0','intelligence');
    addStyle('front-office-liquid.css?v=20.1.0','liquid');
    addStyle('command-surface-v14.css?v=20.1.0','sidecards');
    addStyle('command-surface-v15.css?v=20.1.0','hero');
    addStyle('cockpit-v5.css?v=20.1.0','cockpit-v5');
    addStyle('cockpit-v5-1.css?v=20.1.0','cockpit-v5-1');
    await addScript('front-office-clean.js?v=20.1.0','renderer');
    window.renderWarroom=()=>window.CleanFrontOffice?.render?.();
    window.renderWarroom();
    await addScript('front-office-position-colors.js?v=20.1.0','position-colors');
    await addScript('front-office-photo-integrity.js?v=20.1.0','photo-integrity');
    await addScript('front-office-intelligence-v2.js?v=20.1.0','intelligence');
    await addScript('cockpit-v5.js?v=20.1.0','cockpit-v5');
