'use strict';
(function(){
  const BOOT_VERSION='draft-cockpit-18.2.0';
  ...
  async function boot(){
    ...
    document.querySelectorAll('script[src*="front-office-phase1"],script[src*="front-office-polish"],script[src*="front-office-photo-fix"],script[src*="front-office-photo-integrity"],script[src*="command-surface"],script[src*="cockpit-v1"],script[src*="cockpit-v2"],script[src*="cockpit-v3"],style#phaseOneStyles,link[data-front-office-clean],link[data-front-office-style],script[data-front-office-clean],script[data-front-office-script]').forEach(n=>n.remove());
    document.body.className=document.body.className.replace(/\btbv\S+/g,'').trim();mount();
    addStyle('front-office-clean.css?v=18.2.0','base');addStyle('front-office-layout-v2.css?v=18.2.0','layout');addStyle('front-office-intelligence-v2.css?v=18.2.0','intelligence');addStyle('front-office-liquid.css?v=18.2.0','liquid');addStyle('command-surface-v14.css?v=18.2.0','sidecards');addStyle('command-surface-v15.css?v=18.2.0','hero');addStyle('cockpit-v3.css?v=18.2.0','draft-cockpit-v3');addStyle('cockpit-v3-2.css?v=18.2.0','draft-cockpit-v3-2');
    await addScript('front-office-clean.js?v=18.2.0','renderer');window.renderWarroom=()=>window.CleanFrontOffice?.render?.();window.renderWarroom();await addScript('front-office-position-colors.js?v=18.2.0','position-colors');await addScript('front-office-photo-integrity.js?v=18.2.0','photo-integrity');await addScript('front-office-intelligence-v2.js?v=18.2.0','intelligence');await addScript('cockpit-v3.js?v=18.2.0','draft-cockpit-v3');window.BoardCockpitV3?.apply?.();await addScript('cockpit-v3-2.js?v=18.2.0','draft-cockpit-v3-2');window.BoardCockpitV32?.apply?.();
  }
