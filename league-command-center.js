'use strict';
(function(){
  const BOOT_VERSION='liquid-front-office-6.0.0';
  ...
  async function boot(){
    ...
    mount();
    addStyle('front-office-clean.css?v=6.0.0','base');
    addStyle('front-office-layout-v2.css?v=6.0.0','layout');
    addStyle('front-office-intelligence-v2.css?v=6.0.0','intelligence');
    addStyle('front-office-liquid.css?v=6.0.0','liquid');
    addStyle('command-surface-v6.css?v=6.0.0','command-surface');
    await addScript('front-office-clean.js?v=6.0.0','renderer');
    window.renderWarroom=()=>window.CleanFrontOffice?.render?.();window.renderWarroom();
    await addScript('front-office-intelligence-v2.js?v=6.0.0','intelligence');
    await addScript('command-surface-v6.js?v=6.0.0','command-surface');
  }
