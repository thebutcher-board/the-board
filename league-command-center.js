'use strict';
(function(){
  const BOOT_VERSION='clean-front-office-4.0.0';
  ...
  async function boot(){
    ...
    mount();
    addStyle('front-office-clean.css?v=4.0.0','base');
    addStyle('front-office-layout-v2.css?v=4.0.0','layout');
    addStyle('front-office-intelligence-v2.css?v=4.0.0','intelligence');
    await addScript('front-office-clean.js?v=4.0.0','renderer');
    window.renderWarroom=()=>window.CleanFrontOffice?.render?.();
    window.renderWarroom();
    await addScript('front-office-intelligence-v2.js?v=4.0.0','intelligence');
  }
