'use strict';
(function(){
  const BOOT_VERSION='liquid-front-office-12.0.0';
  ...
  async function boot(){
    ...
    mount();
    addStyle('front-office-clean.css?v=12.0.0','base');
    addStyle('front-office-layout-v2.css?v=12.0.0','layout');
    addStyle('front-office-intelligence-v2.css?v=12.0.0','intelligence');
    addStyle('front-office-liquid.css?v=12.0.0','liquid');
    addStyle('command-surface-v7.css?v=12.0.0','command-surface');
    addStyle('command-surface-v8.css?v=12.0.0','command-surface-polish');
    addStyle('command-surface-v9.css?v=12.0.0','command-surface-final-polish');
    addStyle('command-surface-v10.css?v=12.0.0','command-surface-sketch-polish');
    addStyle('command-surface-v11.css?v=12.0.0','command-surface-microcards');
    addStyle('command-surface-v12.css?v=12.0.0','command-surface-integrity');
    await addScript('front-office-clean.js?v=12.0.0','renderer');
    window.renderWarroom=()=>window.CleanFrontOffice?.render?.();window.renderWarroom();
    await addScript('front-office-position-colors.js?v=12.0.0','position-colors');
    await addScript('front-office-photo-integrity.js?v=12.0.0','photo-integrity');
    await addScript('front-office-intelligence-v2.js?v=12.0.0','intelligence');
  }
