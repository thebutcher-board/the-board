'use strict';
(function(){
  const BOOT_VERSION='draft-cockpit-20.3.0';
  ...
  async function boot(){
    ...
    addStyle('front-office-clean.css?v=20.3.0','base');
    addStyle('front-office-layout-v2.css?v=20.3.0','layout');
    addStyle('front-office-intelligence-v2.css?v=20.3.0','intelligence-css');
    addStyle('front-office-liquid.css?v=20.3.0','liquid');
    addStyle('command-surface-v14.css?v=20.3.0','sidecards-base');
    addStyle('command-surface-v15.css?v=20.3.0','hero-base');
    addStyle('cockpit-v5-2-shell.css?v=20.3.0','cockpit-v52-shell');
    addStyle('cockpit-v5-2.css?v=20.3.0','cockpit-v52');
    addStyle('foundation-controls-v1.css?v=20.3.0','foundation-controls');
    await addScript('foundation-controls-v1.js?v=20.3.0','foundation-controls');
    await addScript('front-office-clean.js?v=20.3.0','renderer');
    window.renderWarroom=()=>window.CleanFrontOffice?.render?.();
    window.renderWarroom();
    await addScript('cockpit-v5-2.js?v=20.3.0','cockpit-v52');
